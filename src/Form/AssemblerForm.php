...
class AssemblerForm extends FormBase {
   ...
   * The form helper.
   *
   * @var \Drupal\isa\AssemblerFormHelper
   */
   ...
   * @param \Drupal\isa\Form\FormHelper $form_helper
   *   The form helper.
   */
      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['config_form']) &&
          ...
          if (isset($extra_feature_info['formbit'])) {
            $formbit_file_name = drupal_get_path('profile', 'isa') . '/' . $extra_feature_info['formbit'];
      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['config_form']) &&
          ...
          if (file_exists($formbit_file_name)) {
            ...
            $GLOBALS['install_state']['isa']['extra_features_configs'] = $extra_features_editable_configs;
          }
        }
      }

      $GLOBALS['install_state']['isa']['extra_features_values'] = $extra_features_values;
    }
  }
